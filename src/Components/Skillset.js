  ...
  return (
    ...
    >
      ...
      <Typography
        ...
        sx={{ m: "15px" }}
      >
        Hello Everyone, I am Riya Jain pursuing Computer Science and Engineering 
        from Shri Ramdeobaba College Of Engineering and Management, Nagpur. I love to explore new stuff and solving challenges.{" "}
        <br />I am an optimistic,determined and self motivated girl.
      </Typography>
