...
const NavBar = () => {
  ...
  const appBarButtons = (
    <Box sx={{ display: "flex", ml: "auto", alignItems: "center" }}>
      ...
      <a className="tag" href="https://drive.google.com/file/d/1Ll2UYNLG5VVeyMHmyKrotCXTHAk7mth3/view?usp=sharing" title="" download >
    ...
    <AppBar position="fixed" color="primary">
      <Toolbar>
        <Stack direction="row" alignItems="center" gap={1} sx={{ flexGrow: 1 }}>
          <Typography variant="h6">Riya Jain</Typography>
